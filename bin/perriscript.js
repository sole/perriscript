...
var argv     = require('optimist').usage('Usage: perriscript <file>').argv;
...
if (argv._[0]) {
    ...
    var ds = new Stream();
    // pipe stdin through the perriscript translator to the repl
    repl.start({
        prompt : "PERRI> ",
        input  : ds,
    ...
    // begin streaming stdin to the perri translator and repl
